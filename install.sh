#!/bin/sh
set -e
# Code generated by godownloader on 2021-06-14T10:00:24Z. DO NOT EDIT.
#

usage() {
  this=$1
  cat <<EOF
$this: download go binaries for findy-network/findy-agent-cli

Usage: $this [-b] bindir [-d] [tag]
  -b sets bindir or installation directory, Defaults to ./bin
  -d turns on debug logging
   [tag] is a tag from
   https://github.com/findy-network/findy-agent-cli/releases
...
PROJECT_NAME="findy-agent-cli"
OWNER=lauravuo
REPO="findy-agent-cli"
BINARY=findy-agent-cli
FORMAT=tar.gz
OS=$(uname_os)
ARCH=$(uname_arch)
PREFIX="$OWNER/$REPO"
